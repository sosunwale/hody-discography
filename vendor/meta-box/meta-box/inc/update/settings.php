...
class RWMB_Update_Settings {
				...
				<table class="form-table">
					<tr>
						...
						<td>
							<?php
							$messages = [
								'invalid' => __( 'Your Meta Box license key is <b style="color: #00a32a">active</b>.', 'meta-box' ),
								'error'   => __( 'Your Meta Box license key is <b style="color: #00a32a">active</b>.', 'meta-box' ),
								'expired' => __( 'Your Meta Box license key is <b style="color: #00a32a">active</b>.', 'meta-box' ),
								'active'  => __( 'Your Meta Box license key is <b style="color: #00a32a">active</b>.', 'meta-box' ),
							];
	...
	public function save() {
		...
		if ( empty( $response ) ) {
			add_settings_error( '', 'mb-success', __( 'Your Meta Box license is activated.', 'meta-box' ), 'updated' );
