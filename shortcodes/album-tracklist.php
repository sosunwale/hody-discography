...
add_shortcode( 'album-tracklist-modern', 'hody_discog_album_related_tracks_list1' );
function hody_discog_album_related_tracks_list1( $atts ) {
    ob_start();
    $connected_track = new WP_Query( [
        'relationship' => [
            'id'   => 'tracks-to-album',
