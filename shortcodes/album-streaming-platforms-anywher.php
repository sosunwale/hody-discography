<?php
//Create Shortcode that list album streaming platforms in loops
...
function hody_discog_album_stream_icons_anywhere( $atts ) {
    ...
    <span class="icon-grid-item">
         <a  href="<?php get_post_meta( $post->ID, 'hody_discog_album_spotify_url', true) ?>" class="discog-icon discog-social-icon discog-social-icon-spotify" target="_blank">
