<?php
//Create Shortcode that list track streaming platforms
add_shortcode( 'track-platform-icons', 'hody_discog_track_stream_icons' );

function hody_discog_track_stream_icons( $atts ) {
    ob_start();
    ?>
